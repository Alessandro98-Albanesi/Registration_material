        ...
        with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as server_socket:
                ...
                while True:
                    ...
                    for i in range(2):
                        ...
                        max_bound = np.array([math.inf,-0.1, 0.6])
                        ...
                        multi = old + pyvista_transformed
                        old = pyvista_transformed

                        
                        

                        
                        multi.plot(point_size=1, color="red")
                    ...
                    multi_points = np.asarray(multi.points).T
                    R_pca,t_pca,T_pca = PCA_registration(multi_points,points_patient_CT)
                    registered_pca = R_pca @ multi_points + t_pca

                    plotter = pv.Plotter()

                    source_cloud = o3d.geometry.PointCloud()
                    source_cloud.points = o3d.utility.Vector3dVector(multi_points.T)  # Transpose for correct shape
                    ...
                    result = o3d.pipelines.registration.registration_icp(
                        ...
                        o3d.pipelines.registration.ICPConvergenceCriteria(max_iteration=10000)  # Max iterations
                    )
